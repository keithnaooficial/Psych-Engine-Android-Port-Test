...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Who Is Happy Now?",		"Beat Mickey's week on Hard with no Misses.",				'week1_nomiss',			false],
		["What Colo(u)r Is YOUR Bugaty?",	"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
		["I Have The Best Gaming Chair!",				"Complete a Song with a rating of 100%.",			'ur_good',				false],
		["Oversinging Much...?",		"Hold down a note for 20 seconds.",					'oversinging',			false],
		["What's idle?",					"Finish a Song without going Idle.",				'hype',					false],
		["Just the Two of Us",			"Finish a Song pressing only two keys.",			'two_keys',				false],
		["My pc running minecraft...",				
	];
